...
import { SiGooglecloud, SiAwslambda, SiTensorflow, SiPytorch } from "react-icons/si";
  ...
  const CircuitPatternAnimation = () => {
    return (
      <div className="absolute inset-0 opacity-10">
        ...
        <svg width="100%" height="100%" className="absolute inset-0" style={{ transform: "rotate(45deg)" }}>
          <motion.path
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-center relative z-10">
              ...
              <div className="md:col-span-2 flex justify-center">
                <div className="relative h-64 w-64 md:h-80 md:w-80">
                  ...
                  {/* Orbiting tech icons */}
                  {[FaBrain, FaRobot, FaNetworkWired, FaMicrochip].map((Icon, index) => (
                    <motion.div
              ...
              <div className="md:col-span-3 text-left space-y-6">
                <div>
                  <h3
                    className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 via-blue-500 to-purple-600"
                  >
                    {teamMembers[0].name}
                  </h3>
                  <p
                    className="mt-2 text-2xl text-teal-300 font-semibold"
                  >
                    {teamMembers[0].role}
                  </p>
                </div>
                ...
                <p className="text-gray-300 text-lg leading-relaxed max-w-3xl">
                  {teamMembers[0].bio} - A visionary in the field of artificial intelligence and technological innovation, 
                  driving breakthrough solutions that transform industries and enhance user experiences. With a passion for 
                  cutting-edge technology and a deep understanding of both business and technical challenges, 
                  leading the way in creating AI systems that are both powerful and accessible.
                </p>

                {/* Skills */}
                <div className="flex flex-wrap gap-3 mt-8">
                  <h4 className="text-white font-semibold text-lg w-full mb-2">Areas of Expertise:</h4>
                  {[...teamMembers[0].skills, "Artificial Intelligence", "Machine Learning", "Neural Networks", "Data Science", "Computer Vision"].map((skill) => (
                    <motion.span
                      key={skill}
                ...
                {/* Certifications */}
                <div className="mt-8">
                  <h4 className="text-white font-semibold text-lg mb-4">Certifications & Achievements:</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {[...teamMembers[0].certifications, "AI Research Pioneer", "Digital Transformation Leader"].map((cert, i) => (
                      <motion.div
                        key={i}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="absolute inset-0 opacity-10">
                <svg width="100%" height="100%">
                  ...
                  <line x1="20%" y1="30%" x2="30%" y2="50%" stroke="rgba(45,212,191,0.3)" strokeWidth="1" />
                  <line x1="40%" y1="20%" x2="30%" y2="50%" stroke="rgba(45,212,191,0.3)" strokeWidth="1" />
                  <line x1="60%" y1="30%" x2="50%" y2="60%" stroke="rgba(45,212,191,0.3)" strokeWidth="1" />
                  <line x1="80%" y1="20%" x2="70%" y2="50%" stroke="rgba(45,212,191,0.3)" strokeWidth="1" />
                  <line x1="30%" y1="50%" x2="20%" y2="80%" stroke="rgba(45,212,191,0.3)" strokeWidth="1" />
                  <line x1="30%" y1="50%" x2="50%" y2="80%" stroke="rgba(45,212,191,0.3)" strokeWidth="1" />
                  <line x1="50%" y1="60%" x2="50%" y2="80%" stroke="rgba(45,212,191,0.3)" strokeWidth="1" />
                  <line x1="70%" y1="50%" x2="80%" y2="80%" stroke="rgba(45,212,191,0.3)" strokeWidth="1" />
                </svg>
              </div>
              
              <FaBrain className="h-10 w-10 text-teal-500 mb-4 relative z-10" />
              <h3 className="text-xl font-bold text-white mb-2 relative z-10">Our Vision</h3>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white mb-2 relative z-10">Our Mission</h3>
              <p className="text-gray-400 relative z-10">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white mb-2 relative z-10">Our Values</h3>
              <p className="text-gray-400 relative z-10">
