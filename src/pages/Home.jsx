...
const Statisticssection = lazy(() => import("../components/HomePage/Statisticssection"));
...
// Loading fallback component with inline styles
const SectionLoader = ({ height = "500px" }) => (
  <div className="flex items-center justify-center" style={{ height }}>
    ...
    <div className="flex space-x-2">
      ...
      <div 
        className="w-3 h-3 bg-blue-500 rounded-full" 
        style={{ animation: "pulse 1s infinite alternate 0.2s" }}
      ></div>
      <div 
        className="w-3 h-3 bg-blue-500 rounded-full" 
        style={{ animation: "pulse 1s infinite alternate 0.4s" }}
      ></div>
    </div>
  </div>
);
...
const companyData = {
  ...
  "@type": "Organization",
  "name": "CODENOVATECH",
  "alternateName": ["Code Nova Tech", "CodeNova Tech", "Codenova tech", "CodeNova Technology"],
  ...
  "keywords": "AI company Coimbatore, Codenovatech, Code Novatech, Codenova tech, AI solutions India, software development Coimbatore"
};
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const sectionObserver = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        ...
        if (sectionId && (entry.isIntersecting || entry.intersectionRatio > 0)) {
    ...
    const sections = ['hero-section', 'services-section', 'team-section', 'statistics-section'];
    sections.forEach(id => {
  ...
  useEffect(() => {
    document.title = "CODENOVATECH | Top AI & Software Development Company in Coimbatore";
  }, []);
      ...
      <div className="min-h-screen bg-gray-900 text-white">
        ...
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            ></div>
            <h2 className="mt-6 text-2xl font-bold">Loading CODENOVATECH</h2>
            <p className="mt-2 text-gray-400">Preparing AI-powered experience...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="bg-gray-900 text-white">
      ...
      <Helmet>
        ...
        <link rel="alternate" hrefLang="x-default" href="https://codenovatech.in" />
      </Helmet>
      
      {/* Hidden SEO content for search engines - visible to crawlers but not obtrusive to users */}
      <div className="sr-only">
        <h1>CODENOVATECH - Leading AI and Software Development Company in Coimbatore</h1>
        <p>Welcome to Code Nova Tech (CODENOVATECH), the premier AI and software development company in Coimbatore, Tamil Nadu. We provide innovative artificial intelligence solutions, machine learning implementation, and custom software development services.</p>
        <p>Codenova tech delivers cutting-edge technology solutions including generative AI, computer vision, natural language processing, and full-stack development for businesses across India.</p>
